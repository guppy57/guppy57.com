  ...
  return (
    <li>
      ...
      >
        {children}
        {isActive && (
          <span className="absolute inset-x-1 -bottom-px h-px bg-gradient-to-r from-purple-500/0 via-purple-600/40 to-purple-500/0 dark:from-purple-400/0 dark:via-purple-300/40 dark:to-purple-400/0" />
        )}
      </Link>
    </li>
  );
